...
labelNum1 = tk.Label(root, text="Value1").grid(row=1, column=0)  
  
labelNum2 = tk.Label(root, text="Value2").grid(row=2, column=0)

labelNum3 = tk.Label(root, text="Operator").grid(row=3, column=0)  
